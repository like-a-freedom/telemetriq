...
import type { OverlayConfig, ExtendedOverlayConfig, AppScreen, TemplateId } from '../core/types';
import { DEFAULT_OVERLAY_CONFIG } from '../modules/overlay-renderer';
import { getTemplateConfig, getAvailableTemplates } from '../modules/template-configs';
